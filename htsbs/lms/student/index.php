...
/*
====================================
⚠️ مهم: ملف header.php يعيد تعريف المتغير $student
ويجعله يحتوي على (class_name, student_number) فقط.
لذلك نحفظ بيانات الطالب الكاملة في متغير خاص بالوحدة
قبل استدعاء الهيدر، ونستخدمه في بطاقة الطالب بالأسفل.
====================================
*/
$lmsStudent = $student;
  ...
  <div class="card-body">
    <div class="row align-items-center">
      <div class="col-md-2 text-center mb-3 mb-md-0">
        <?php if (!empty($lmsStudent['profile_image'])): ?>
          <img src="<?= BASE_URL ?>/uploads/profiles/<?= e($lmsStudent['profile_image']) ?>"
      ...
      <div class="col-md-7">
        <h3 class="fw-bold mb-1"><?= e($lmsStudent['full_name']) ?></h3>
        <div class="row small mt-2 g-2">
          <div class="col-6 col-md-4"><i class="bi bi-person-vcard"></i> الرقم الشخصي: <?= e($lmsStudent['national_id'] ?? '—') ?></div>
          <div class="col-6 col-md-4"><i class="bi bi-hash"></i> الرقم الأكاديمي: <?= e($lmsStudent['student_number'] ?? '—') ?></div>
          <div class="col-6 col-md-4"><i class="bi bi-mortarboard"></i> التخصص: <?= e($lmsStudent['department_name'] ?? '—') ?></div>
          <div class="col-6 col-md-4"><i class="bi bi-bar-chart-steps"></i> المستوى: <?= e($lmsStudent['academic_level'] ?? '—') ?></div>
          <div class="col-6 col-md-4"><i class="bi bi-people"></i> الصف: <?= e($lmsStudent['class_name'] ?? '—') ?></div>
