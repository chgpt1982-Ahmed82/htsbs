...
$behaviorModel = new BehaviorNote();
...
$behaviorStats = $behaviorModel->behaviorStatistics($_SESSION['user_id']);
...
<div class="col-md-4">
    <a href="<?= BASE_URL ?>/messages/inbox.php"
       class="text-decoration-none">
...
<!-- 
<div class="col-md-4">
    <a href="<?= BASE_URL ?>/teacher/behavior/index.php"
       class="text-decoration-none">
...
-->
    ...
    <div class="col-md-4">
  <!--  <a href="<?= BASE_URL ?>/teacher/assignments/index.php" class="text-decoration-none"> -->
